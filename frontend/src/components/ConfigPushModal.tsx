  ...
  const fetchHosts = async () => {
    try {
      ...
      const filteredHosts = allHosts.filter(host => {
        ...
        return hasRole('splunk_cm') ||
               hasRole('splunk_deployer') ||
               hasRole('splunk_license_master') ||
               hasRole('splunk_monitoring_console') ||
               hasRole('splunk_deployment_server') ||
               hasRole('splunk_search_head') ||
               hasRole('splunk_indexer') ||
               hasRole('splunk_hf') ||
               hasRole('splunk_uf') || 
               hasRole('splunk_enterprise') ||
